    ...
    <div className="flex items-center justify-between px-4 bg-[#111] border-b border-white/10">
      <div className="flex">
        {VIEWS.map(({ key, label, tooltip }) => (
          <button
            ...
            className={`px-5 py-2.5 text-[13px] border-b-2 transition-colors duration-base ${
              currentView === key
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className={`px-2 py-1 rounded text-[11px] font-medium transition-colors duration-base ${
            showReviewed
