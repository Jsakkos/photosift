...
pub struct AppState {
    ...
    /// queries hit the cache without issuing SQL.
    pub percentile_cache: Option<(i64, Option<String>, SharpnessPercentiles)>,
}
...
impl AppState {
    pub fn new() -> Self {
        ...
        Self {
            ...
            ai_eye_provider: EyeProviderKind::Absent,
            ai_mouth_provider: MouthProviderKind::Absent,
