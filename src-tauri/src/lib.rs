...
pub fn run() {
    ...
    let builder = builder
        ...
        let builder = builder.invoke_handler(tauri::generate_handler![
            ...
            commands::culling::get_bracket_decisions_for_shoot,
            commands::culling::record_bracket_decision,
            commands::culling::delete_bracket_decision,
            commands::settings::get_settings,
            commands::settings::update_settings,
            commands::settings::recluster_shoot,
            commands::settings::recluster_shoot_with,
            ...
            commands::curator::get_triage_judgments_for_shoot,
            commands::curator::apply_triage_rejects,
